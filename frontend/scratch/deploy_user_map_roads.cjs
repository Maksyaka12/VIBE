...
async function deployUserMapRoads() {
  ...
  console.log(`Loading user's exact road layer: ${userRoadsPath}`);
  ...
  console.log(`Successfully saved user's transparent roads PNG to ${outPath}`);
}

deployUserMapRoads().catch(console.error);
